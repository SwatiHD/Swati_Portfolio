...
export default function Contact({ mode }) {
  return (
    <>
      <section
        id="contact"
        className="pb-20 px-6 scroll-mt-20 max-w-6xl mx-auto"
      >
      ...
      {/* Copyright */}
      <footer className="mt-20 border-t border-slate-800 pt-8 pb-4">
  <div className="flex flex-col items-center gap-3 text-center">
    ...
    <p className="text-slate-400 max-w-md text-sm leading-6">
      Feel free to connect if you'd like to collaborate, discuss ideas,
      or build something amazing together.
    </p>

    <div className="w-16 h-[2px] bg-teal-400 rounded-full mt-2"></div>

    <p className="text-xs text-slate-500 mt-2">
      © {new Date().getFullYear()} Swati HD • Built with React & Tailwind CSS
    </p>
  </div>
</footer>
    </>
